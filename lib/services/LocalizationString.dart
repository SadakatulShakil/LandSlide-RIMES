...
class LocalizationString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'uploading': 'Uploading',
      'uploading_msg': 'Saving image locally...',
      'uploading_failed': 'Upload Failed',
      'uploading_failed_msg': 'Could not save image. Please try again.',
      ...
      'gallery': 'Gallery',
      'success': 'Success',
      'welcome_speech': 'WELCOME TO Landslide Report',
      'login_speech': 'Please Enter the mobile number to login',
      'login_btn': 'Login',
      'mobile_title': 'Enter Mobile Number',
      'draft': 'Draft',
      'complete': 'Complete',
      'sync_now': 'Sync Now',
      'sync_survey': 'Sync Survey',
      'sync_progress': 'Syncing in progress...',
      'sync_alert': 'Check your internet connection before syncing survey data.',
    },
    'bn_BD': {
      'title': 'LandSlide Report',
      'tool': 'tool',
      ...
      'uploading_msg': 'ছবি স্থানীয়ভাবে সংরক্ষণ করা হচ্ছে...',
      'uploading_failed': 'আপলোড ব্যর্থ',
      'uploading_failed_msg': 'ছবি সংরক্ষণ করতে ব্যর্থ। অনুগ্রহ করে আবার চেষ্টা করুন।',
      ...
      'gallery': 'গ্যালারি',
      'success': 'সফল',
      'welcome_speech': 'ভূমিধস রিপোর্টে আপনাকে স্বাগতম',
      'login_speech': 'লগইন করতে মোবাইল নম্বর দিন',
      'login_btn': 'লগইন',
      'mobile_title': 'মোবাইল নম্বর দিন',
      'draft': 'ড্রাফট',
      'complete': 'কমপ্লিট',
      'sync_now': 'সিঙ্ক করুন',
      'sync_survey': 'জরিপ সিঙ্ক করুন',
      'sync_progress': 'সিঙ্ক প্রক্রিয়া চলছে...',
      'sync_alert': 'জরিপ ডেটা সিঙ্ক করার আগে আপনার ইন্টারনেট সংযোগ চেক করুন।',
    }
  };
}
